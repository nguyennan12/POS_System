...
public static class RoleErrors
{
    ...
    public static readonly Error Forbidden = new(ErrorType.Forbidden, "Role.Forbidden", "Bạn không có quyền quản lý hoặc truy cập vai trò trong phạm vi cửa hàng này.");
