...
namespace POS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903070053_FixOrderDiscountCascadePaths")]
    partial class FixOrderDiscountCascadePaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Domain.Orders.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_orders_status", "status IN ('Draft','Confirmed','Paid','Cancelled','Refunded','PartiallyRefunded')");
                        });
                });
            ...
            modelBuilder.Entity("POS.Domain.Orders.Returns.OrderReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("order_returns", null, t =>
                        {
                            t.HasCheckConstraint("ck_order_returns_refund_amount", "refund_amount >= 0");

                            t.HasCheckConstraint("ck_order_returns_status", "status IN ('Pending','Approved','Rejected')");
                        });
                });

            modelBuilder.Entity("POS.Domain.Orders.Returns.OrderReturnItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("order_return_items", null, t =>
                        {
                            t.HasCheckConstraint("ck_order_return_items_qty", "qty > 0");

                            t.HasCheckConstraint("ck_order_return_items_refund_amount", "refund_amount >= 0");
                        });
                });
            ...
            modelBuilder.Entity("POS.Domain.Orders.Returns.OrderReturn", b =>
                {
                    ...
                    b.HasOne("POS.Domain.Employees.Employee", "ProcessedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("POS.Domain.Orders.Returns.OrderReturnItem", b =>
                {
                    b.HasOne("POS.Domain.Orders.OrderItem", "OrderItem")
                        .WithMany()
                        .HasForeignKey("OrderItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POS.Domain.Orders.Returns.OrderReturn", "Return")
                        .WithMany("Items")
